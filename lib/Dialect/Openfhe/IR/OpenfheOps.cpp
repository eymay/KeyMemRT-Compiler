...
//   auto enc =
//   this->getPlaintext().getType().getPlaintextSpace().getEncoding(); if
//   (!llvm::isa<lwe::FullCRTPackingEncodingAttr>(enc)) {
//     return emitOpError("plaintext type should use
//     full_crt_packing_encoding.");
//   }
//   return success();
// }
//
...
//   auto enc =
//   this->getPlaintext().getType().getPlaintextSpace().getEncoding(); if
//   (!llvm::isa<lwe::InverseCanonicalEncodingAttr>(enc)) {
//     return emitOpError("plaintext type should use
//     inverse_canonical_encoding.");
//   }
//   return success();
// }
