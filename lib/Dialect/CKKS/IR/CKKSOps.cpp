...
//
// LogicalResult RelinearizeOp::verify() { return
// lwe::verifyRelinearizeOp(this); }
//
...
//
// LogicalResult LevelReduceOp::verify() { return
// lwe::verifyLevelReduceOp(this); }
//
// //===----------------------------------------------------------------------===//
// Op type inference.
//===----------------------------------------------------------------------===//
...
//     MLIRContext *ctx, std::optional<Location>, RelinearizeOp::Adaptor
//     adaptor, SmallVectorImpl<Type> &inferredReturnTypes) {
//   return lwe::inferRelinearizeOpReturnTypes(ctx, adaptor,
//   inferredReturnTypes);
// }
