// RUN: keymemrt-opt --symbolic-bsgs-decomposition --kmrt-merge-rotation-keys %s | FileCheck %s
...
!pt = !lwe.lwe_plaintext<plaintext_space = <ring = #ring_f64_1, encoding = #inverse_canonical_encoding1>>
